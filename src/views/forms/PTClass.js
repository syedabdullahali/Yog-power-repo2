import { CAccordion, CAccordionBody, CAccordionHeader, CAccordionItem,
     CButton, CCard, CCardBody, CCardHeader, CCardTitle, CCol, CForm, 
     CFormInput, CFormSelect, CImage, CInputGroup, CListGroup, 
     CListGroupItem, CPopover, CRow, CSpinner } from '@coreui/react'
            ...
            <CCardBody>
                <CForm>
                    <CRow>
                        ...
                        <CCol xs={3}>
                            <CButton className="mt-2 float-end me-3 " onClick={() => setLiveClass(!liveClass)} >'
                            {!liveClass ? 'Add PT Classes' : 'Close'}</CButton>
                        </CCol>
                    </CRow>
                </CForm>
