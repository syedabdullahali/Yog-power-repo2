...
const OfferMarketing = () => {
   ...
   console.log(  (ServiceFees/100) ,  +Discount)
   console.log(  (ServiceFees/100) *  +Discount)
                            ...
                            <CRow className='mt-3'>
                                ...
                                <CCol lg={6} md={6} sm={12}>
                                    ...
                                    >
                                        ...
                                        {result.filter((list) => list.username === username && list.Service === ServiceName)
                                            .map((item, index) => (
                                                <option key={index}>{item.Variation}</option>
                                            ))}
                                    </CFormSelect>
                                </CCol>
                                <CCol lg={6} md={6} sm={12}>
                                    ...
                                    >
                                        ...
                                        {result.filter((list) => list.username === username 
                                        && list.Service === ServiceName && list.Variation === ServiceVariation)
                                            .map((item, index) => (
                                ...
                                <CCol lg={6} md={6} sm={12}>
                                    ...
                                    >
                                        ...
                                        {result.filter((list) => list.username === username && list.Service === ServiceName &&
                                         list.Variation === ServiceVariation)
                                            .map((item, index) => (
                                ...
                                <CCol lg={6} md={6} sm={12}>
                                    <CFormInput
                                        ...
                                        onChange={(e) => { setDiscount(e.target.value), 
                                            setNetFees(+e.target.value * getPerc(ServiceFees) )}}
